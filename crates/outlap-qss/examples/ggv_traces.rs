...
//!
//! Four sections, one CSV with a `section` column:
...
fn main() {
    ...
    for &v in &[0.35_f64, 0.6, 0.9] {
        ...
        for i in 0..=80 {
            ...
            println!("gg,{ax:.4},{:.4},{v:.2}", env.ay_boundary(v, ax, G));
        }
    }
    ...
    for i in 0..=60 {
        ...
        println!("speed,{v:.3},{:.4},0", env.ay_boundary(v, 0.0, G));
    }
    ...
    for i in 0..=60 {
        ...
        println!("corr,{v:.3},{corrected:.4},{truth:.4}");
    }
}
